 ...
 * @Last Modified time: 2018-02-27 14:08:12
 */
define('ebook_page', ['jquery', 'jqueryTransit', 'ebook_eleAnimation', 'ebook_tools'], function(require) {
    var vars = seajs.data.vars;

    var $ = require('jquery'),
        tools = require('ebook_tools'),
        eleAnimation = require('ebook_eleAnimation');
    ...
    Page.prototype = {
        ...
        changePage: function(toPage) {
            ...
            vars.eles.preview.turn('page', vars.current + 1);
