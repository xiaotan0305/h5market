...
/**
 * Project:     搜房网php框架
 * File:        Smarty2Adapter.php
 *
 * <pre>
 * 描述：Smarty2到Yaf_View视图引擎适配类
 * </pre>
 *
 * @category   PHP
 * @package    Application
 ...
 * @link       http://example.com
 */
class Smarty2Adapter implements Yaf_View_Interface
{
    /**
     * Smarty对象
     * @var obj
    ...
    public function __construct($tmplPath = null, $extraParams = array())
    {
        ...
        $this->_smarty->register_outputfilter(array(&$this,'htmlConcentrate'));
...
/* End of file Smarty2Adapter.php */
